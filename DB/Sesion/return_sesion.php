...
// Echo session variables that were set on previous page
    if(isset($_SESSION["start"]))
    {
        if($_SESSION["token"] == "SI")
        {
            ...
            echo "<meta http-equiv='refresh' content='3; url= http://localhost/whiskey/DB/Sesion/start_sesion.php'>";
        }
    }else{
        echo "<h3>"."inicializa una sesion."."</h3>";
        echo "<meta http-equiv='refresh' content='2; url= http://localhost/whiskey/DB/Sesion/start_sesion.php'>";
    }
