...
<div class="container">
  ...
  <div id="content-perfil" class="content" style="display: none;">
    ...
    <p>Ya no puedo mas, Ya no puedo masAlso notice that we have set overflow:auto to sidenav. This will add a scrollbar when the sidenav is too long (for example if it has over 50 links inside of it).</p>
    <p>Some text..</p>
    <p>Some text..</p>
    <p>Some text..</p>
    <p>Some text..</p>
